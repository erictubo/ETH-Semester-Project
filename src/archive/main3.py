...
for i, keyframe in enumerate(keyframes):
    ...
    points_gps_array        # = gps_3D_points
    pixels_annotated_array  # = observed_2D_points

    camera_intrinsics = keyframe.Camera.intrinsics_vector

    camera_pose = keyframe.Camera.pose_vector

    print("Optimising camera pose")

    # Call ceres solver
    # new_camera_pose = optimize_camera_pose(points_gps_array, pixels_annotated_array, camera_intrinsics, camera_pose)
